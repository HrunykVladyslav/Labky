...
#define TOKENS_RE         "->|==|!=|!|&|\\||add|sub|\\*|/|%|lt|gt|\\(|\\)|\\{|\\}|\\[|\\]|,|;|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       "->|==|!=|!|&|\\||add|sub|\\*|/|%|lt|gt|\\(|\\)|\\{|\\}|\\[|\\]|,|;|program|var|begin|end|read|write|if|else|while|continue|break|int32"
...
#define DEFAULT_INPUT_FILE "H04_1.txt"
